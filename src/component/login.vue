...
.login .input-form .user-ico {
    background-position: 0.14rem -1.3rem;
}


/* line 8, ../sass/ie.scss */

.login .input-form .pw-ico {
    background-position: 0.14rem -2.3rem;
}
...
<div id="login-box">
    ...
    <div class="login">
        <div class="input-form">
            ...
            <span v-show="userName!=''" @click="userName=''" class="del-txst"></span>
        </div>
        <div class="input-form">
            <i class="pw-ico"></i>
